...
![Reaction resonance gameplay](https://github.com/Gyorgy0/Reaction-resonance-eframe/blob/master/README%20media%20files/gameplay_video.mp4?raw=true)
...
|A|Advances the simulation by one iteration|
|R|Resets the board|
...
- [egui_dialogs](https://github.com/a-littlebit/egui_dialogs) 
- [egui-colorgradient](https://gitlab.com/polwel/egui-colorgradient) 
- [wasm-bindgen-rayon](https://github.com/RReverser/wasm-bindgen-rayon) 
- [android_logger-rs](https://github.com/rust-mobile/android_logger-rs) 
- [env_logger](https://github.com/rust-cli/env_logger) 
- [exrs](https://github.com/johannesvollmer/exrs) 
